...
genome = '/mnt/raid/users/stephan/01_jiraTickets/ITD_1162_FirstSeqRun/00_ref/human_g1k_v37_decoy_CHr5.fasta'
...
rule all:
    input:
        ...
        ancient(expand('../03_mapped/{sample}/{sample}Aligned.sortedByCoord.out.bam', sample=SAMPLES)),
...
rule Minimap2:
    ...
    priority: 50
    shell:
        "minimap2 -ax sr -t {threads} {Genom} {input.r1} {input.r2} |\
